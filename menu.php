                ...
                <ul class="mainnav">
                    ...
                    <li class="dropdown">					
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li <?php echo $active ?>><a href="index.php?pgy=lap-pembayaran-supir&page=view">Pembayaran Supir</a></li>
                            <li <?php echo $active ?>><a href="index.php?pgy=lap-pembayaran-siswa&page=view">Pembayaran Siswa</a></li>
